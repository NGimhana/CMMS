    ...
    export default {
        ...
        methods: {
            ...
            deleteJobTask :function () {
                this.$http.delete('http://cmms.com/api/job/'+this.selectedJob.id).then(response => {
            ...
            completeJobTask: function () {
              this.getToday();
              this.$http.put('http://cmms.com/api/job/'+this.selectedJob.id ,
                  {
            ...
            completedJobsFetch:function () {
                this.url = 'http://cmms.com/api/jobs/completedjobs';
                this.$http.get(this.url).then(response => {
            ...
            onGoingJobsFetch:function () {
                this.url = 'http://cmms.com/api/jobs/ongoingjobs';
                this.$http.get(this.url).then(response => {
                    this.jobs = response.body;
                    console.log(this.jobs);
                    // this.makePagination(response.data);
            ...
            recentJobsFetch:function () {
                this.url = 'http://cmms.com/api/jobs/recentjobs';
                this.$http.get(this.url).then(response => {
                    this.jobs = response.body;
                    console.log(this.jobs);
                    // this.makePagination(response.data);
            ...
            overdueJobsFetch:function () {
                this.url = 'http://cmms.com/api/jobs/overduejobs';
                this.$http.get(this.url).then(response => {
                    this.jobs = response.body;
                    console.log(this.jobs);
                    // this.makePagination(response.data);
            ...
            fetchAllJobs:function () {
              this.url = 'http://cmms.com/api/job';
                this.$http.get(this.url).then(response => {
                    this.jobs = response.data.data;
                    console.log(this.jobs);
                    this.makePagination(response.data);
