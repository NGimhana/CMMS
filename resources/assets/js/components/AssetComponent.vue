...
<script>
    export default {
        ...
        methods: {
            ...
            fetchData: function () {
                this.$http.get('http://cotence.000webhostapp.com/api/assets/fullassetdetails').then(response => {
                    let p = response.body;
                    this.assets = p;
            ...
            searchAsset: function () {
                ...
                this.$http.get('http://cotence.000webhostapp.com/api/assets/fullassetdetails/'+this.searchText).then(response=>{
            ...
            fetchBuildings:function () {
                this.$http.get('http://cotence.000webhostapp.com/api/buildings').then(response=>{
            ...
            searchSector:function (buildingid) {
                this.$http.get('http://cotence.000webhostapp.com/api/building/sector/'+buildingid).then(response=>{
            ...
            AddAsset:function () {
                ...
                this.$http.post('http://cotence.000webhostapp.com/api/asset',
                    {
